...
export default function HealingLight() {
  return (
    <div className="min-h-screen bg-gray-50">
      <Head>
        <title>Healing Light | EGFM USA</title>
        <meta
          name="description"
          content="Join Healing Light, an EGFM USA meeting focused on spiritual and physical restoration."
        />
        <meta property="og:title" content="Healing Light | EGFM USA" />
        <meta
          property="og:description"
          content="Join Healing Light for spiritual and physical restoration."
        />
      </Head>
      <Navbar />
      <main className="flex-grow">
        <HeroSection
          ...
          title="Healing Light"
          subtitle="Special teaching series with Rev. Kayode Oyegoke"
        />
        <section className="max-w-7xl mx-auto px-4 pb-16 mt-16 grid grid-cols-1 md:grid-cols-2 gap-10 items-start relative">
          <div className="bg-white/80 backdrop-blur-lg rounded-2xl shadow-2xl p-8 flex flex-col gap-6 border border-gray-100">
            ...
            <p className="text-lg text-gray-700 mb-4">
              Come experience the transformative power of God at our annual summer teaching series, “Healing Light” held every year in Houston, Texas. Under the divine guidance of the Lord, Rev. Kayode and Helen Oyegoke, His faithful servant and hand-maiden, deliver teachings from the throne of God that speak to the souls of men across America and beyond. 
            </p>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="text-gray-700">Houston, Texas</div>
            </div>
          </div>
          <div className="relative mt-12 md:mt-32">
            <ImageCarousel
              images={[
                { image: '/images/meeting-highlight-2.1.jpg', name: 'Word' },
                { image: '/images/region-southeast.jpg', name: 'Worship' },
                { image: '/images/regions-static.jpg', name: 'Prayer Gathering' },
                { image: '/images/meeting-highlight-2.jpg', name: 'All at Healing Light!' },
              ]}
            />
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
              {[1, 2, 3].map((i) => (
                ...
                >
                  ...
                  <p className="text-gray-500 text-sm mb-2">Rev. Kayode Oyegoke</p>
