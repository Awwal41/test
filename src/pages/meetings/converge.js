...
export default function Converge() {
  return (
    <div className="min-h-screen bg-gray-50">
      <Head>
        <title>Converge | EGFM USA</title>
        <meta
          name="description"
          content="Experience Converge, a dynamic EGFM USA meeting uniting believers for worship and spiritual growth."
        />
        <meta property="og:title" content="Converge | EGFM USA" />
        <meta
          property="og:description"
          content="Experience Converge, uniting believers for worship and growth."
        />
      </Head>
      <Navbar />
      <main className="flex-grow">
        <HeroSection
          ...
          title="Converge"
          subtitle="How good and pleasant it is for brethren to dwell together in unity!"
        />
        <section className="max-w-7xl mx-auto px-4 pb-16 mt-16 grid grid-cols-1 md:grid-cols-2 gap-10 items-start relative">
          <div className="bg-white/80 backdrop-blur-lg rounded-2xl shadow-2xl p-8 flex flex-col gap-6 border border-gray-100">
            ...
            <p className="text-lg text-gray-700 mb-4">
              How good and pleasant it is for brethren to dwell together in unity! Converge is an annual winter conference that avails brethren the opportunity to fulfill this scripture. This is an open conference to all and sundry, invited to come together and be blessed by God, and to learn practical life skills required for a successful journey of faith. Make plans to join us this winter, we will be elated to see you!!
            </p>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <ul className="list-disc list-inside text-gray-600 col-span-1 sm:col-span-2 ml-8">
                <li>Inspiring teachings & worship</li>
                <li>Fellowship</li>
                <li>Spiritual growth</li>
              </ul>
              <div className="flex items-center gap-3">
                <FaCalendarAlt className="text-amber-500 text-2xl" />
                <span className="font-semibold text-gray-800">Next Meeting:</span>
              </div>
          ...
          <div className="relative mt-12 md:mt-32">
            <ImageCarousel
              images={[
                { image: '/images/meeting-highlight-2.1.jpg', name: 'Worship' },
                { image: '/images/region-southeast.jpg', name: 'Word' },
                { image: '/images/regions-static.jpg', name: 'Fellowship' },
                { image: '/images/meeting-highlight-2.jpg', name: 'All at Converge!' },
              ]}
            />
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
              {[1, 2, 3].map((i) => (
                ...
                >
                  ...
                  <span className="text-xs text-gray-400">Dec 2022</span>
                </div>
              ))}
            </div>
